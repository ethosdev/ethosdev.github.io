...
While finding the input for a hash should be infeasible, computing a hash should be fast to compute. Most hash functions can hash hundreds of megabytes in a second.
